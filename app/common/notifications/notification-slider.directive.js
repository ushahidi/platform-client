...
function NotificationSlider() {
    return {
        restrict: 'E',
        transclude: true,
        templateUrl: 'templates/common/notifications/notification-slider.html',
...
NotificationSliderController.$inject = ['$scope', '$attrs', '$parse', '$timeout'];
function NotificationSliderController($scope, $attrs, $parse, $timeout) {
