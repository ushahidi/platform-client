...
describe("FormEndpoint", () => {
    let $rootScope, $httpBackend, BACKEND_URL, FormEndpoint;
    ...
    beforeEach(() => {
        ...
        testApp
            .service(
                "FormEndpoint",
                require("app/common/services/endpoints/form.js")
            )
    ...
    beforeEach(
        angular.mock.inject(
            (_$httpBackend_, _$rootScope_, _CONST_, _FormEndpoint_) => {
    ...
    describe('"forms/:id" for data of all forms', () => {
        describe("get all forms", () => {
            let mockFormDataResponse;
            ...
            beforeEach(() => {
                mockFormDataResponse = {
                    ...
                    orderby: "id",
                    curr:
                        "http://192.168.33.110/api/v3/forms?orderby=id&order=asc&offset=0",
                    next:
                        "http://192.168.33.110/api/v3/forms?orderby=id&order=asc&offset=0",
                    prev:
                        "http://192.168.33.110/api/v3/forms?orderby=id&order=asc&offset=0",
            ...
            it("should call the correct url and parse and return the correct data", () => {
                ...
                $httpBackend
                    .expectGET(`${BACKEND_URL}/api/v3/forms`)
                    .respond(mockFormDataResponse);
                ...
                const actualFormData = successCallback.calls.mostRecent()
                    .args[0];
                expect(actualFormData.length).toEqual(
                    mockFormDataResponse.results.length
                );
                expect(actualFormData[0].form).toEqual(
                    mockFormDataResponse.results[0].form
                );
            });
    ...
    describe('get data for "forms/1"', () => {
        ...
        describe("get form data", () => {
            it("should call the correct url and return the correct data", () => {
                const successCallback = jasmine.createSpy("success");
                $httpBackend
                    .expectGET(`${BACKEND_URL}/api/v3/forms/1`)
                    .respond(mockFormDataResponse);
        ...
        describe("update form data", () => {
            ...
            it("should call the correct url and return the updated form data", () => {
                const successCallback = jasmine.createSpy("success");
                $httpBackend
                    .expectPUT(`${BACKEND_URL}/api/v3/forms/1`)
                    .respond(mockFormDataResponse);
                ...
                FormEndpoint.update(formDataToUpdate).$promise.then(
                    successCallback
                );
                ...
                expect(actualFormData.description).toEqual(
                    formDataToUpdate.description
                );
            });
            ...
            it("using saveCache should call the correct url and return the correct data", () => {
                ...
                FormEndpoint.saveCache({ id: 1 }).$promise.then(
                    successCallback
                );
            ...
            it("should return an id when deleting an entity", () => {
                const successCallback = jasmine.createSpy("success");
                $httpBackend
                    .expectDELETE(`${BACKEND_URL}/api/v3/forms/1`)
                    .respond(mockFormDataResponse);

                FormEndpoint.deleteEntity({ id: 1 }).$promise.then(
                    successCallback
                );
