...
function ActiveSearchFilters() {
    return {
        ...
        controller: ActiveSearchFiltersController
    };
}
ActiveSearchFiltersController.$inject = ['$scope', 'PostFilters', '_', 'FilterTransformers', '$rootScope', '$state'];
function ActiveSearchFiltersController($scope, PostFilters, _, FilterTransformers, $rootScope, $state) {
    $scope.uiFilters = {};
