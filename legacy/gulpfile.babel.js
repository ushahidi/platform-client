...
let paths = {
    ...
    entry: {
        ...
        'ushahidi-data': path.join(__dirname, root, '/data/data-module.js'),
        'ushahidi-activity': path.join(__dirname, root, '/activity/activity-module.js'),
        'ushahidi-settings': path.join(__dirname, root, '/settings/settings.module.js')
    },
    output: root,
