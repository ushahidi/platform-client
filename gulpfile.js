 ...
 */
gulp.task('transifex-download', function (gulp_cb) {
    ...
    transifex.languageSetMethods(function (err, data) {
        ...
        transifex.statisticsMethods(project_slug, resource, function (err, stats) {
            ...
            async.eachLimit(data, 2, function(language, async_cb) {
...
/* This is commented out because we can't really resolve and rewrite all the references
