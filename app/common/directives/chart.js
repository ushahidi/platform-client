angular.module('ushahidi.common.chart', ['dc'])
...
function (
    ...
    return {
        ...
        template: '<div class="chart-overlay" ng-show="options.isLoading || libLoading"><i class="fa fa-refresh fa-4 fa-spin"></i></div><div class="chart-overlay" ng-show="noData && !options.isLoading">No activity during selected period.</div>',
        link: function (scope, iElement, iAttrs) {

            scope.libLoading = true;

            //init after dc.js loads
            dcService.dc().then( function (dc) {
                scope.libLoading = false;
                /*
