...
describe("RoleEndpoint", () => {
    let $rootScope, $httpBackend, BACKEND_URL, RoleEndpoint;
    ...
    beforeEach(() => {
        ...
        testApp
            .service(
                "RoleEndpoint",
                require("app/common/services/endpoints/role.js")
            )
    ...
    beforeEach(
        angular.mock.inject(
            (_$httpBackend_, _$rootScope_, _CONST_, _RoleEndpoint_) => {
    ...
    describe('"roles/:id" for data of all roles', () => {
        describe("get all roles", () => {
            let mockRoleDataResponse;
            ...
            beforeEach(() => {
                mockRoleDataResponse = {
                    ...
                    orderby: "id",
                    curr:
                        "http://192.168.33.110/api/v3/roles?orderby=id&order=asc&offset=0",
                    next:
                        "http://192.168.33.110/api/v3/roles?orderby=id&order=asc&offset=0",
                    prev:
                        "http://192.168.33.110/api/v3/roles?orderby=id&order=asc&offset=0",
            ...
            it("should call the correct url and parse and return the correct data", () => {
                ...
                $httpBackend
                    .expectGET(`${BACKEND_URL}/api/v3/roles`)
                    .respond(mockRoleDataResponse);
                ...
                const actualRoleData = successCallback.calls.mostRecent()
                    .args[0];
                expect(actualRoleData.length).toEqual(
                    mockRoleDataResponse.results.length
                );
                expect(actualRoleData[0].name).toEqual(
                    mockRoleDataResponse.results[0].name
                );
            });
    ...
    describe('get data for "roles/1"', () => {
        ...
        describe("get role data", () => {
            it("should call the correct url and return the correct data", () => {
                const successCallback = jasmine.createSpy("success");
                $httpBackend
                    .expectGET(`${BACKEND_URL}/api/v3/roles/1`)
                    .respond(mockRoleDataResponse);
                ...
                expect(actualRoleData.display_name).toEqual(
                    mockRoleDataResponse.display_name
                );
        ...
        describe("update role data", () => {
            ...
            it("should call the correct url and return the updated role data", () => {
                const successCallback = jasmine.createSpy("success");
                $httpBackend
                    .expectPUT(`${BACKEND_URL}/api/v3/roles/1`)
                    .respond(mockRoleDataResponse);
                ...
                RoleEndpoint.update(roleDataToUpdate).$promise.then(
                    successCallback
                );
                ...
                expect(actualRoleData.description).toEqual(
                    roleDataToUpdate.description
                );
            });
            ...
            it("using saveCache should call the correct url and return the correct data", () => {
                ...
                RoleEndpoint.saveCache({ id: 1 }).$promise.then(
                    successCallback
                );
            ...
            it("should return an id when deleting an entity", () => {
                const successCallback = jasmine.createSpy("success");
                $httpBackend
                    .expectDELETE(`${BACKEND_URL}/api/v3/roles/1`)
                    .respond(mockRoleDataResponse);

                RoleEndpoint.deleteEntity({ id: 1 }).$promise.then(
                    successCallback
                );
