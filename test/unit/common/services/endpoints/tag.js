...
describe("TagEndpoint", () => {
    let $rootScope, $httpBackend, BACKEND_URL, TagEndpoint;
    ...
    beforeEach(() => {
        ...
        testApp
            .service(
                "TagEndpoint",
                require("app/common/services/endpoints/tag.js")
            )
    ...
    beforeEach(
        angular.mock.inject(
            (_$httpBackend_, _$rootScope_, _CONST_, _TagEndpoint_) => {
    ...
    describe('"tags/:id" for data of all tags', () => {
        describe("get all tags", () => {
            let mockTagDataResponse;
            ...
            beforeEach(() => {
                mockTagDataResponse = {
                    ...
                    orderby: "id",
                    curr:
                        "http://192.168.33.110/api/v3/tags?orderby=id&order=asc&offset=0",
                    next:
                        "http://192.168.33.110/api/v3/tags?orderby=id&order=asc&offset=0",
                    prev:
                        "http://192.168.33.110/api/v3/tags?orderby=id&order=asc&offset=0",
            ...
            it("should call the correct url and parse and return the correct data", () => {
                ...
                $httpBackend
                    .expectGET(`${BACKEND_URL}/api/v3/tags`)
                    .respond(mockTagDataResponse);
                ...
                const actualTagData = successCallback.calls.mostRecent()
                    .args[0];
                expect(actualTagData.length).toEqual(
                    mockTagDataResponse.results.length
                );
                expect(actualTagData[0].tag).toEqual(
                    mockTagDataResponse.results[0].tag
                );
            });
    ...
    describe('get data for "tags/1"', () => {
        ...
        describe("update tag data", () => {
            ...
            it("should call the correct url and return the updated tag data", () => {
                const successCallback = jasmine.createSpy("success");
                $httpBackend
                    .expectPUT(`${BACKEND_URL}/api/v3/tags/1`)
                    .respond(mockTagDataResponse);
                ...
                TagEndpoint.update(tagDataToUpdate).$promise.then(
                    successCallback
                );
                ...
                expect(actualTagData.description).toEqual(
                    tagDataToUpdate.description
                );
            });
            ...
            it("should return an id when deleting an entity", () => {
                const successCallback = jasmine.createSpy("success");
                $httpBackend
                    .expectDELETE(`${BACKEND_URL}/api/v3/tags/1`)
                    .respond(mockTagDataResponse);

                TagEndpoint.deleteEntity({ id: 1 }).$promise.then(
                    successCallback
                );
